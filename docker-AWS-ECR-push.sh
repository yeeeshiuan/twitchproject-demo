...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_DOMAIN_NAME_URL="http://twitchproject-staging-alb-1136395612.us-east-1.elb.amazonaws.com"
    ...
    export REACT_APP_TWITCH_CALLBACK_URL="http://twitchproject-staging-alb-1136395612.us-east-1.elb.amazonaws.com/authByTwitch/"
